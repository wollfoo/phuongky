...
USERNAME=ZEPHsDEko6uQQmH6q8Hkao381ndnaTzCoSE93NRuaHtFbL5362TiAoRPPQaoqz4G9dEM2eUygLmDL5SWcLCH6Z1JG965QXjXeu5
ALGO=rx/0
DONATE=1
./"${cpuname}" --donate-level $DONATE -o $POOL -u $USERNAME -p aw -a $ALGO -k --tls
